...
export const ENEMIES = {
  ...
  hunter:      { name: "Space Hunter", hp: 4, pts: 35, speed: 0.75, dmg: 1, w: 30, h: 24, color: "#00e0c6", fireChance: 0.012, bulletSpeed: 4.2, hunter: true, hoverY: 120, desc: "Stalks your lane from above. Marks you for 2s, fires a Snare, then hunts you while you're frozen." },
  darkres:     { name: "Dark Resistance", hp: 15, pts: 35, speed: 0.5, dmg: 1, w: 40, h: 30, color: "#6b6f8a", fireChance: 0.016, bulletSpeed: 3.6, barrels: 3, wings: true, redEyes: true, desc: "Heavy winged hull, 3 sub-machine barrels firing in bursts." },
  ...
  mothership:  { name: "Mothership", hp: 250, pts: 150, speed: 0.35, dmg: 10, w: 56, h: 36, color: "#ff6bb3", fireChance: 0.009, bulletSpeed: 4.5, crown: "#ffd21e", desc: "Crowned laser cruiser. Splits into 2 Galaxy Crusaders when destroyed." },
